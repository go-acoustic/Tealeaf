Pod::Spec.new do |s|
  ...
  s.platforms = { :ios => "9.0" }
  s.source = { :git => 'https://github.com/acoustic-analytics/Tealeaf.git', :tag => '10.6.999'}
  s.default_subspec = 'Core'
  s.subspec 'Core' do |core|
    core.frameworks = 'SystemConfiguration', 'CoreTelephony', 'CoreLocation', 'WebKit'
    core.library = 'z'
    core.resource = "SDKs/iOS/Debug/TealeafReactNative/TLFResources.bundle"
    core.xcconfig = { 'HEADER_SEARCH_PATHS' => '"$(PODS_ROOT)/SDKs/iOS/Debug/TealeafReactNative.xcframework/*/TealeafReactNative.framework/Headers/"/** ' }
    core.vendored_frameworks = 'SDKs/iOS/Debug/TealeafReactNative/TealeafReactNative.xcframework'
